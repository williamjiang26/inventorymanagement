...
const RectangleVertical = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("rectangle-vertical", __iconNode);
;
...
"[project]/node_modules/react-filepond/dist/react-filepond.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _filepond = __turbopack_context__.r("[project]/node_modules/filepond/dist/filepond.js [app-client] (ecmascript)");
...
"[project]/node_modules/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/filepond-plugin-image-exif-orientation/dist/filepond-plugin-image-exif-orientation.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/filepond-plugin-pdf-preview/dist/filepond-plugin-pdf-preview.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ /* eslint-disable */ (function(global, factory) {
    ...
    const createPdfView = (_)=>_.utils.createView({
            name: 'pdf-preview',
            tag: 'div',
            ignoreRect: true,
            create: ({ root, props })=>{
                ...
                if (isPreviewablePdf(item.file)) {
                    ...
                    root.ref.pdf.setAttribute('style', 'position:absolute;left:0;right:0;margin:auto;padding-top:unset;' + (numPdfPreviewHeight ? 'height:' + numPdfPreviewHeight + 'px;' : ''));
            ...
            write: _.utils.createRoute({
                DID_PDF_PREVIEW_LOAD: ({ root, props })=>{
                    ...
                    root.ref.pdf.addEventListener('load', ()=>{
                        if (isPreviewablePdf(item.file)) {
                            root.dispatch('DID_UPDATE_PANEL_HEIGHT', {
                                id: id,
     ...
     */ const create = ({ root, props })=>{
            ...
            root.ref.pdf = root.appendChildView(root.createChildView(pdf, {
                id: props.id
            }));
        };
        return _.utils.createView({
   ...
   */ const plugin = (fpAPI)=>{
        ...
        addFilter('CREATE_VIEW', (viewAPI)=>{
            ...
            const didLoadItem = ({ root, props })=>{
                ...
                // set preview view
                root.ref.PdfPreview = view.appendChildView(view.createChildView(pdfWrapperView, {
                    id
                }));
                // now ready
            ...
            view.registerWriter(createRoute({
                ...
                if (!isPreviewablePdf(item.file) || root.rect.element.hidden) return;
            }));
        });
        // expose plugin
        return {
...
//# sourceMappingURL=node_modules_73b63f9a._.js.map